...
export const VEHICLES: Vehicle[] = [
  ...
  makeVehicle({
    slug: "nevado-manual",
    commercialName: "NEVADO MANUAL",
    technicalName: "NEVADO MANUAL",
    trimLabel: "SUV",
    typeTag: "SUV · Manual",
    categorySlug: "suv",
    order: 0,
  ...
  makeVehicle({
    slug: "tepuy-pro",
    commercialName: "TEPUY PRO",
    technicalName: "TEPUY PRO",
    trimLabel: "SUV",
    typeTag: "SUV · Automático",
    categorySlug: "suv",
    order: 1,
    featureIcons: ["gasoil-car"],
    colors: [{ name: "Blanco", hex: BODY_COLORS.Blanco }],
  ...
  makeVehicle({
    slug: "savanna",
    commercialName: "SAVANNA",
    technicalName: "SAVANNA",
    trimLabel: "SUV",
    typeTag: "SUV · Automático",
    categorySlug: "suv",
    order: 2,
  ...
  makeVehicle({
    slug: "arena-pro",
    commercialName: "ARENA PRO",
    technicalName: "ARENA PRO",
    trimLabel: "SUV",
    typeTag: "SUV · Automático",
    categorySlug: "suv",
    order: 3,
