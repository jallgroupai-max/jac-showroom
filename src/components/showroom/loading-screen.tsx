 ...
 * calidad de conexión decide cuánto se espera aquí antes de dejar pasar al
 * usuario (readyThresholdForTier) — el resto sigue cargando en segundo plano
 * de forma transparente dentro del visualizador.
 */
